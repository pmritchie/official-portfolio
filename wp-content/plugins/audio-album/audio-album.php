...
License: GPLv2
  ...
  Copyright 2013-2020 Michael Atkins
...
*
*/
define( 'CC_AUDIOALBUM_VERSION', '1.4.0' );
...
function cc_audioalbum_scripts() {
	wp_register_script( 'audioalbum', plugins_url( '/js/audiotrackpopup.js' , __FILE__ ), array( 'jquery' ), CC_AUDIOALBUM_VERSION, true );

	$audioalbumscript = 'jQuery(window).load(function() { jQuery(".albumtrack").css("visibility", "visible"); jQuery(".track").css("background-image", "none"); });';
